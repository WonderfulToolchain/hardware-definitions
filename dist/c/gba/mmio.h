...
/**
 * Prevent the video hardware from accessing the object attribute memory (OAM) during horizontal blank.
 * 
 * As this option reduces the duration available for reading memory by the video hardware, it also reduces the maximum number of sprites that can be displayed per line.
 */
#define GBA_LCD_DISPCNT_OAM_HBLANK_FREE 0x20
...
/**
 * Disable all video memory access by the hardware. This will cause all output pixels to be white, but allow free memory access by the CPU.
 */
#define GBA_LCD_DISPCNT_FORCE_DISABLE 0x80
/**
...
/**
 * Tile bit depth; also controls palette count.
 */
...
/**
 * Tile background layer size, in tiles
 */
...
/**
 * Affine background layer size, in pixels
 */
...
#define GBA_LCD_BLENDCNT_SRC_BG0 0x01
#define GBA_LCD_BLENDCNT_SRC_BG1 0x02
#define GBA_LCD_BLENDCNT_SRC_BG2 0x04
#define GBA_LCD_BLENDCNT_SRC_BG3 0x08
#define GBA_LCD_BLENDCNT_SRC_OBJ 0x10
#define GBA_LCD_BLENDCNT_SRC_BACK 0x20
/**
 * Disable blending.
 */
#define GBA_LCD_BLENDCNT_MODE_NONE 0x00
/**
 * Mix the source and destination pixel according to BLENDALPHA.
 */
#define GBA_LCD_BLENDCNT_MODE_ALPHA 0x40
/**
 * Increase the brightness of the source pixel according to BLENDMUL.
 */
#define GBA_LCD_BLENDCNT_MODE_BRIGHTEN 0x80
/**
 * Decrease the brightness of the source pixel according to BLENDMUL.
 */
#define GBA_LCD_BLENDCNT_MODE_DARKEN 0xC0
#define GBA_LCD_BLENDCNT_MODE_SHIFT 6
#define GBA_LCD_BLENDCNT_MODE_MASK 0xC0
#define GBA_LCD_BLENDCNT_DST_BG0 0x100
#define GBA_LCD_BLENDCNT_DST_BG1 0x200
#define GBA_LCD_BLENDCNT_DST_BG2 0x400
#define GBA_LCD_BLENDCNT_DST_BG3 0x800
#define GBA_LCD_BLENDCNT_DST_OBJ 0x1000
#define GBA_LCD_BLENDCNT_DST_BACK 0x2000

#define GBA_LCD_BLENDALPHA (*((volatile uint16_t*) 0x4000052))

#define GBA_LCD_BLENDSRCALPHA (*((volatile uint8_t*) 0x4000052))

#define GBA_LCD_BLENDDSTALPHA (*((volatile uint8_t*) 0x4000053))
...
/**
 * State of the serial input pin
 */
#define GBA_SIO_CNT_SPI_INPUT 0x04
#define GBA_SIO_CNT_SPI_OUTPUT_POLARITY_LOW 0x00
#define GBA_SIO_CNT_SPI_OUTPUT_POLARITY_HIGH 0x08
#define GBA_SIO_CNT_SPI_OUTPUT_POLARITY_SHIFT 3
#define GBA_SIO_CNT_SPI_OUTPUT_POLARITY_MASK 0x08
#define GBA_SIO_CNT_SPI_START 0x80
/**
 * 9600 baud/sec
 */
...
#define GBA_SIO_CNT_MULTI_START 0x80
/**
 * 9600 baud/sec
 */
...
/**
 * @addtogroup hardware_sound Hardware defines - Sound MMIO
 * @{
 */

#define GBA_SOUND_CH1_SWEEP (*((volatile uint8_t*) 0x4000060))
#define GBA_SOUND_CH1_SWEEP_DIR_UP 0x00
#define GBA_SOUND_CH1_SWEEP_DIR_DOWN 0x08
#define GBA_SOUND_CH1_SWEEP_DIR_SHIFT 3
#define GBA_SOUND_CH1_SWEEP_DIR_MASK 0x08

#define GBA_SOUND_CH1_LEN (*((volatile uint8_t*) 0x4000062))
#define GBA_SOUND_CH1_LEN_DUTY_12_5 0x00
#define GBA_SOUND_CH1_LEN_DUTY_25 0x40
#define GBA_SOUND_CH1_LEN_DUTY_50 0x80
#define GBA_SOUND_CH1_LEN_DUTY_75 0xC0
#define GBA_SOUND_CH1_LEN_DUTY_SHIFT 6
#define GBA_SOUND_CH1_LEN_DUTY_MASK 0xC0

#define GBA_SOUND_CH1_ENV (*((volatile uint8_t*) 0x4000063))
#define GBA_SOUND_CH1_ENV_DIR_UP 0x00
#define GBA_SOUND_CH1_ENV_DIR_DOWN 0x08
#define GBA_SOUND_CH1_ENV_DIR_SHIFT 3
#define GBA_SOUND_CH1_ENV_DIR_MASK 0x08

#define GBA_SOUND_CH1_CNT (*((volatile uint16_t*) 0x4000064))
#define GBA_SOUND_CH1_CNT_LENGTH 0x4000
#define GBA_SOUND_CH1_CNT_RESTART 0x8000

#define GBA_SOUND_CH2_LEN (*((volatile uint8_t*) 0x4000068))
#define GBA_SOUND_CH2_LEN_DUTY_12_5 0x00
#define GBA_SOUND_CH2_LEN_DUTY_25 0x40
#define GBA_SOUND_CH2_LEN_DUTY_50 0x80
#define GBA_SOUND_CH2_LEN_DUTY_75 0xC0
#define GBA_SOUND_CH2_LEN_DUTY_SHIFT 6
#define GBA_SOUND_CH2_LEN_DUTY_MASK 0xC0

#define GBA_SOUND_CH2_ENV (*((volatile uint8_t*) 0x4000069))
#define GBA_SOUND_CH2_ENV_DIR_UP 0x00
#define GBA_SOUND_CH2_ENV_DIR_DOWN 0x08
#define GBA_SOUND_CH2_ENV_DIR_SHIFT 3
#define GBA_SOUND_CH2_ENV_DIR_MASK 0x08

#define GBA_SOUND_CH2_CNT (*((volatile uint16_t*) 0x400006C))
#define GBA_SOUND_CH2_CNT_LENGTH 0x4000
#define GBA_SOUND_CH2_CNT_RESTART 0x8000

#define GBA_SOUND_CH3_ENA (*((volatile uint8_t*) 0x4000072))
/**
 * Play from selected bank
 */
#define GBA_SOUND_CH3_ENA_BANKS_ONE 0x00
/**
 * Play from both banks
 */
#define GBA_SOUND_CH3_ENA_BANKS_TWO 0x20
#define GBA_SOUND_CH3_ENA_BANKS_SHIFT 5
#define GBA_SOUND_CH3_ENA_BANKS_MASK 0x20
/**
 * Play (starting from) bank 0
 */
#define GBA_SOUND_CH3_ENA_ACTIVE_0 0x00
/**
 * Play (starting from) bank 1
 */
#define GBA_SOUND_CH3_ENA_ACTIVE_1 0x40
/**
 * Select the active bank
 */
#define GBA_SOUND_CH3_ENA_ACTIVE_SHIFT 6
#define GBA_SOUND_CH3_ENA_ACTIVE_MASK 0x40
#define GBA_SOUND_CH3_ENA_ENABLE 0x80

#define GBA_SOUND_CH3_LEN (*((volatile uint8_t*) 0x4000072))

#define GBA_SOUND_CH3_VOL (*((volatile uint8_t*) 0x4000073))

#define GBA_SOUND_CH3_CNT (*((volatile uint16_t*) 0x4000074))
#define GBA_SOUND_CH3_CNT_LENGTH 0x4000
#define GBA_SOUND_CH3_CNT_RESTART 0x8000

#define GBA_SOUND_CH4_LEN (*((volatile uint8_t*) 0x4000078))

#define GBA_SOUND_CH4_ENV (*((volatile uint8_t*) 0x4000079))
#define GBA_SOUND_CH4_ENV_DIR_UP 0x00
#define GBA_SOUND_CH4_ENV_DIR_DOWN 0x08
#define GBA_SOUND_CH4_ENV_DIR_SHIFT 3
#define GBA_SOUND_CH4_ENV_DIR_MASK 0x08

#define GBA_SOUND_CH4_CNT (*((volatile uint16_t*) 0x400007C))
#define GBA_SOUND_CH4_CNT_LENGTH 0x4000
#define GBA_SOUND_CH4_CNT_RESTART 0x8000

#define GBA_SOUND_CH3_WAVE (*((volatile uint8_t(*)[16]) 0x4000090))

#define GBA_SOUND_CH3_WAVE16 (*((volatile uint16_t(*)[8]) 0x4000090))

#define GBA_SOUND_CH3_WAVE32 (*((volatile uint32_t(*)[4]) 0x4000090))

#define GBA_SOUND_FIFOA (*((volatile uint32_t*) 0x40000A0))

#define GBA_SOUND_FIFOB (*((volatile uint32_t*) 0x40000A4))

#define GBA_SOUND_MVOLCNT (*((volatile uint8_t*) 0x4000080))

#define GBA_SOUND_CHNCNT (*((volatile uint8_t*) 0x4000081))
#define GBA_SOUND_CHNCNT_CH1_RIGHT 0x01
#define GBA_SOUND_CHNCNT_CH2_RIGHT 0x02
#define GBA_SOUND_CHNCNT_CH3_RIGHT 0x04
#define GBA_SOUND_CHNCNT_CH4_RIGHT 0x08
#define GBA_SOUND_CHNCNT_CH1_LEFT 0x10
#define GBA_SOUND_CHNCNT_CH2_LEFT 0x20
#define GBA_SOUND_CHNCNT_CH3_LEFT 0x40
#define GBA_SOUND_CHNCNT_CH4_LEFT 0x80

#define GBA_SOUND_VOLCNT (*((volatile uint8_t*) 0x4000082))

#define GBA_SOUND_DMACNT (*((volatile uint8_t*) 0x4000083))
#define GBA_SOUND_DMACNT_A_RIGHT 0x01
#define GBA_SOUND_DMACNT_A_LEFT 0x02
#define GBA_SOUND_DMACNT_A_TIMER_0 0x00
#define GBA_SOUND_DMACNT_A_TIMER_1 0x04
#define GBA_SOUND_DMACNT_A_TIMER_SHIFT 2
#define GBA_SOUND_DMACNT_A_TIMER_MASK 0x04
#define GBA_SOUND_DMACNT_A_RESET 0x08
#define GBA_SOUND_DMACNT_B_RIGHT 0x10
#define GBA_SOUND_DMACNT_B_LEFT 0x20
#define GBA_SOUND_DMACNT_B_TIMER_0 0x00
#define GBA_SOUND_DMACNT_B_TIMER_1 0x40
#define GBA_SOUND_DMACNT_B_TIMER_SHIFT 6
#define GBA_SOUND_DMACNT_B_TIMER_MASK 0x40
#define GBA_SOUND_DMACNT_B_RESET 0x80

#define GBA_SOUND_MCNT (*((volatile uint8_t*) 0x4000084))
#define GBA_SOUND_MCNT_CH1_ACTIVE 0x01
#define GBA_SOUND_MCNT_CH2_ACTIVE 0x02
#define GBA_SOUND_MCNT_CH3_ACTIVE 0x04
#define GBA_SOUND_MCNT_CH4_ACTIVE 0x08
#define GBA_SOUND_MCNT_DMA_ENABLE 0x80

#define GBA_SOUND_PWMCNT (*((volatile uint16_t*) 0x4000088))
/**
 * 32.768 KHz; converts each PCM sample into 512 PWM samples for an effective 9-bit resolution.
 */
#define GBA_SOUND_PWMCNT_FREQ_32KHZ 0x00
/**
 * 65.536 KHz; converts each PCM sample into 256 PWM samples for an effective 8-bit resolution.
 */
#define GBA_SOUND_PWMCNT_FREQ_65KHZ 0x4000
/**
 * 131.072 KHz; converts each PCM sample into 128 PWM samples for an effective 7-bit resolution.
 */
#define GBA_SOUND_PWMCNT_FREQ_131KHZ 0x8000
/**
 * 262.144 KHz; converts each PCM sample into 64 PWM samples for an effective 6-bit resolution.
 */
#define GBA_SOUND_PWMCNT_FREQ_262KHZ 0xC000
/**
 * Output frequency; controls the effective resolution.
 */
#define GBA_SOUND_PWMCNT_FREQ_SHIFT 14
#define GBA_SOUND_PWMCNT_FREQ_MASK 0xC000
...
/**
 * ROM area 0 (0x8000000 - 0x9FFFFFE) first access waitstate
 */
...
/**
 * ROM area 0 (0x8000000 - 0x9FFFFFE) sequential access waitstate
 */
...
/**
 * ROM area 1 (0xA000000 - 0xBFFFFFE) first access waitstate
 */
...
/**
 * ROM area 1 (0xA000000 - 0xBFFFFFE) sequential access waitstate
 */
...
/**
 * ROM area 2 (0xC000000 - 0xDFFFFFE) first access waitstate
 */
...
/**
 * ROM area 2 (0xC000000 - 0xDFFFFFE) sequential access waitstate
 */
...
/**
 * Clock output to cartridge on PHI pin
 */

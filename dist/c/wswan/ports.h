// Auto-generated by hardware-definitions/generate.py on 2025-05-04 15:24

#ifndef WS_PORTS_H_
#define WS_PORTS_H_

/**
 * @addtogroup hardware.cart.bank Hardware defines - Cartridge banking I/O ports
 * @{
 */
...
#define WS_CART_BANK_FLASH_ENABLE 0x02
#define WS_CART_BANK_FLASH_DISABLE 0x00
#define WS_CART_BANK_FLASH_SHIFT 1
#define WS_CART_BANK_FLASH_MASK 0x02

/**
 * Linear ROM (0x40000 - 0xFFFFF) bank address.
 */
#define WS_CART_BANKEXT_ROML_PORT 0xCF

/**
 * RAM (0x10000 - 0x1FFFF) bank address (up to 4 GiB).
 */
#define WS_CART_BANKEXT_RAM_PORT 0xD0

/**
 * ROM0 (0x20000 - 0x2FFFF) bank address (up to 4 GiB).
 */
#define WS_CART_BANKEXT_ROM0_PORT 0xD2

/**
 * ROM1 (0x30000 - 0x3FFFF) bank address (up to 4 GiB).
 */
#define WS_CART_BANKEXT_ROM1_PORT 0xD4

/**@}*/

/**
 * @addtogroup hardware.cart.eeprom Hardware defines - Cartridge EEPROM I/O ports
 * @{
 */
...
/**
 * @addtogroup hardware.cart.gpio Hardware defines - Cartridge GPIO I/O ports
 * @{
 */
...
/**
 * @addtogroup hardware.cart.karnak Hardware defines - Karnak mapper I/O ports
 * @{
 */
...
/**
 * @addtogroup hardware.cart.rtc Hardware defines - Cartridge RTC I/O ports
 * @{
 */
...
/**
 * @addtogroup hardware.display Hardware defines - Display hardware I/O ports
 * @{
 */
...
#define WS_SPR_BASE_ADDR(n) (((uint16_t) (n)) >> 9)
...
#define WS_SCR_BASE_1_ADDR(n) (((uint16_t) (n)) >> 11)
#define WS_SCR_BASE_2_ADDR(n) ((((uint16_t) (n)) >> 11) << 4)
...
/**
 * @addtogroup hardware.dma Hardware defines - DMA I/O ports (color-exclusive)
 * @{
 */
...
#define WS_GDMA_CTRL_SHIFT 6
#define WS_GDMA_CTRL_MASK 0x40
 ...
 */
#define WS_SDMA_SOURCE_L_PORT 0x4E

/**
 * High 4 bits of the sound DMA transfer length.
 */
#define WS_SDMA_SOURCE_H_PORT 0x50
...
#define WS_SDMA_CTRL_SHIFT 6
#define WS_SDMA_CTRL_MASK 0x40
/**
...
#define WS_SDMA_CTRL_SHIFT 3
#define WS_SDMA_CTRL_MASK 0x08
...
/**
 * @addtogroup hardware.eeprom Hardware defines - Internal EEPROM I/O ports
 * @{
 */
...
/**
 * @addtogroup hardware.hyper_voice Hardware defines - Hyper Voice I/O ports (color-exclusive)
 * @{
 */
...
/**
 * @addtogroup hardware.interrupts Hardware defines - Interrupt control I/O ports
 * @{
 */
...
/**
 * @addtogroup hardware.keypad Hardware defines - Keypad I/O ports
 * @{
 */
...
/**
 * @addtogroup hardware.soc Hardware defines - System control I/O ports
 * @{
 */
 ...
 */
#define WS_SYSTEM_CTRL_COLOR_CART_CLOCK_FAST 0x01
/**
...
#define WS_SYSTEM_CTRL_COLOR_COLOR 0x80
#define WS_SYSTEM_CTRL_COLOR_4BPP 0x40
#define WS_SYSTEM_CTRL_COLOR_PACKED 0x20
 ...
 */
#define WS_SYSTEM_CTRL_COLOR 0x02
/**
 * IPL is locked.
 */
...
/**
 * @addtogroup hardware.sound Hardware defines - Sound I/O ports
 * @{
 */
...
#define WS_SOUND_WAVE_BASE_PORT 0x04
#define WS_SOUND_WAVE_BASE_ADDR(n) (((uint16_t) (n)) >> 6)
...
#define WS_SOUND_OUT_CTRL_VOLUME_100 0x00
#define WS_SOUND_OUT_CTRL_VOLUME_50 0x02
#define WS_SOUND_OUT_CTRL_VOLUME_25 0x04
#define WS_SOUND_OUT_CTRL_VOLUME_12_5 0x06
#define WS_SOUND_OUT_CTRL_VOLUME_SHIFT 1
#define WS_SOUND_OUT_CTRL_VOLUME_MASK 0x06

#define WS_SOUND_NOISE_LFSR_PORT 0x92

#define WS_SOUND_VOL_CH2_VOICE_PORT 0x94
#define WS_SOUND_VOL_CH2_VOICE_LEFT_NONE 0x00
#define WS_SOUND_VOL_CH2_VOICE_LEFT_HALF 0x08
#define WS_SOUND_VOL_CH2_VOICE_LEFT_FULL 0x0C
#define WS_SOUND_VOL_CH2_VOICE_LEFT_SHIFT 2
#define WS_SOUND_VOL_CH2_VOICE_LEFT_MASK 0x0C
#define WS_SOUND_VOL_CH2_VOICE_RIGHT_NONE 0x00
#define WS_SOUND_VOL_CH2_VOICE_RIGHT_HALF 0x02
#define WS_SOUND_VOL_CH2_VOICE_RIGHT_FULL 0x03
#define WS_SOUND_VOL_CH2_VOICE_RIGHT_SHIFT 0
#define WS_SOUND_VOL_CH2_VOICE_RIGHT_MASK 0x03
...
/**
 * @addtogroup hardware.timers Hardware defines - Timer control I/O ports
 * @{
 */
...
/**
 * @addtogroup hardware.uart Hardware defines - UART I/O ports
 * @{
 */
